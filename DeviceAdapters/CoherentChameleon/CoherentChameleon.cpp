...
int CoherentChameleon::Initialize()
{
	...
	MapProperty(BASEPLATE_TEMP, "Head baseplate temperature (°C)", true, MM::Float);
	MapProperty(DIODE1_TEMP, "Diode #1 temperature (°C)", true, MM::Float);
	MapProperty(DIODE2_TEMP, "Diode #2 temperature (°C)", true, MM::Float);
	MapProperty(VANADATE_TEMP, "Vanadate temperature (°C)", true, MM::Float);
	MapProperty(LBO_TEMP, "LBO temperature (°C)", true, MM::Float);
	MapProperty(ETALON_TEMP, "Etalon temperature (°C)", true, MM::Float);
	MapProperty(DIODE1_SET_TEMP, "Diode #1 set temperature (°C)", true, MM::Float);
	MapProperty(DIODE2_SET_TEMP, "Diode #2 set temperature (°C)", true, MM::Float);
	MapProperty(VANADATE_SET_TEMP, "Vanadate set temperature (°C)", true, MM::Float);
	MapProperty(LBO_SET_TEMP, "LBO set temperature (°C)", true, MM::Float);
	MapProperty(ETALON_SET_TEMP, "Etalon set temperature (°C)", true, MM::Float);
	...
	MapProperty(DIODE1_HEATSINK_TEMP, "Diode #1 heat sink temperature (°C)", true, MM::Float);
	MapProperty(DIODE2_HEATSINK_TEMP, "Diode #2 heat sink temperature (°C)", true, MM::Float);
